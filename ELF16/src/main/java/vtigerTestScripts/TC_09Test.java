...
public class TC_09Test extends BaseClass {
	...
	@Test
	public void createContactTC_09() throws InterruptedException {
		...
		newContact.getUserRadiobtn().click();
		WebElement userListBox = newContact.getUserListBox();
		Select select=new Select(userListBox);
		Thread.sleep(2000);
